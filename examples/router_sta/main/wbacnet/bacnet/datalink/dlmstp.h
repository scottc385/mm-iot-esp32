...
BACNET_STACK_EXPORT
uint32_t dlmstp_receive_queue_capacity(void);
BACNET_STACK_EXPORT
uint32_t dlmstp_receive_queue_count(void);
BACNET_STACK_EXPORT
uint32_t dlmstp_receive_queue_depth(void);
BACNET_STACK_EXPORT
uint32_t dlmstp_receive_queue_drops(void);
